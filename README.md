...
- для OpenWRT в базовой конфигурации: `opkg update && opkg install curl && cd /tmp && curl -sL https://github.com/mrkruvasan/archive/refs/heads/main.tar.gz | tar xz && cd zapretsh-main`
